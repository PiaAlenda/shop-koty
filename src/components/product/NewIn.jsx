...
export default function NewIn() {
  ...
  const [visibleCount, setVisibleCount] = useState(4) // 👈 dinámico
  const sectionRef = useRef(null)
  const navigate = useNavigate()

  // 🔹 Detectar ancho de pantalla para decidir cuántos mostrar
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="container">
        <h2 className="section-title animate-fade-in-up">NUEVO EN</h2>
